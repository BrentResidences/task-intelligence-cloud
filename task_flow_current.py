...
MAIN_TABS = [
    "iPhone Today", "Today List", "Current Priority Notes", "Reports / Print", "Weekly Planning",
...
if current_page == "Ideas / Concepts":
    ...
    if df_pc.empty:
        ...
        for item_type, group in df_pc.groupby("item_type"):
            st.markdown("## Ideas" if item_type=="Ideas" else f"## {item_type}s")
            for r in group.itertuples():
                status_bits = appointment_reminder_status(r)
...
if current_page == "Current Priority Notes":
    st.subheader("Current Priority Notes")
    st.info("Placeholder page for Current Priority Notes.")
