...
# V15: wrapped label-style tabs so the main menu does not run off the right side.
st.markdown("""
<style>
/* Main app tabs: wrap into label-style pills instead of one long sideways row. */
