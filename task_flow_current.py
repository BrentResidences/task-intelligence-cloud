...
# Version 25: report Sort By dropdown now defaults to Date Entered for repository review and uses a new Streamlit key so the option appears immediately.
...
if current_page == "Reports / Print":
    ...
    if report_df.empty:
        ...
        with sf1:
            ...
            default_report_sort_index = 0 if report_priority == "Task Repository" else 1
            report_sort_by = st.selectbox(
                "Sort By",
                report_sort_options,
                index=default_report_sort_index,
                key="report_sort_by_v25",
            )
        with sf2:
