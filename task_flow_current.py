...
def add_delegated_task(title, assignee_name, work_type="Unassigned", subject="Unassigned", priority_type="As Needed", notes="", due="", is_appointment=0, appointment_date="", is_reminder=0, reminder_date="", critical_due_date="", assignee_task_text=""):
    ...
    if not assignee_choices:
        ...
        if not pull_df.empty:
            ...
            if pull_priority != "All":
                pull_df = pull_df[pull_df["priority_type"].fillna("As Needed") == pull_priority].copy()
