...
MAIN_TABS = [
    ...
    "All Items", "Assign Tasks", "Task Repository", "Concept Repository",
...
if current_page == "Fast Reschedule":
    ...
    if fr_source_df.empty:
        ...
        with fd1:
            fr_project = st.selectbox("Filter by Task Repository", project_choices, index=0, key="fast_reschedule_project")
        with fd2:
        ...
        fast_reschedule_sort_columns = ["ID", "Title", "Priority", "Subject", "Work Type", "Task Repository", "Appointment", "Appointment Date", "Reminder", "Reminder Date", "Critical Due Date"]
        with fs1:
        ...
        if st.session_state.fr_grid_loaded is None:
            ...
            edited_df = st.data_editor(
                ...
                num_rows="fixed",
                row_height=84,
                disabled=["ID", "Priority", "Subject", "Work Type", "Task Repository", "Notes Preview"],
                column_config={
                    ...
                    "Task Repository": st.column_config.TextColumn("Task Repository", width="medium"),
