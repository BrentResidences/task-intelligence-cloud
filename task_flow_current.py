...
# Version 10: faster delete actions with callback-based delete and quick delete by item number.
...
def delete_item(item_id):
    ...
    This is intentionally small and explicit because cloud Streamlit reruns the
    whole page after button clicks. Keeping this callback simple makes deletes
    more reliable and avoids the old checkbox-confirm rerun delay.
    """
    item_id = int(item_id)
    with conn() as c:
        cur = c.cursor()
...
with st.expander("Fast Delete by Item #", expanded=False):
    st.caption("Use this when deleting from the full All Items page feels slow. Enter the item number and delete directly from Neon.")
    ...
    with fd2:
        ...
        st.button(
            ...
            key="fast_delete_item_button",
            type="primary",
            on_click=delete_item,
            args=(int(fast_delete_id),),
        )
