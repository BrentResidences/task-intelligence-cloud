...
# Version 30.1: adds an optional condensed task report layout.
...
if current_page == "Reports / Print":
    ...
    if st.session_state.get("report_has_run_v273", False):
        ...
        if report_df.empty:
            ...
            if st.button("Prepare PDF", key="prepare_report_pdf_v301"):
            ...
            if st.session_state.get("report_pdf_condensed_v301"):
                st.download_button(
                    ...
                    mime="application/pdf",
                    key="download_condensed_report_pdf_v301",
                )
