...
# Version 27.1: keeps V27 report filters and removes automatic data migrations/backfills from normal app startup.
...
# Normal startup performs only lightweight schema/table checks.
# IMPORTANT: one-time data migrations and full-table backfills must not run during
# ordinary Streamlit startup or page navigation. Those operations can trigger
# repeated Neon writes, long reruns, and process termination on Streamlit Cloud.
